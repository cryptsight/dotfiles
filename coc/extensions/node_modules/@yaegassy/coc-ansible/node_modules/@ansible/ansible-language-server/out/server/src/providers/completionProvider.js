...
function doCompletion(document, position, context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const useFqcn = (yield context.documentSettings.get(document.uri)).ansible
            .useFullyQualifiedCollectionNames;
        const provideRedirectModulesCompletion = (yield context.documentSettings.get(document.uri)).completion.provideRedirectModules;
        const provideModuleOptionAliasesCompletion = (yield context.documentSettings.get(document.uri)).completion.provideModuleOptionAliases;
