    ...
    if (path) {
        ...
        if (currentNode instanceof types_1.YAMLMap) {
            ...
            pair = _.find(currentNode.items, (p) => {
                ...
                const start = (_a = getOrigRange(p.key)) === null || _a === void 0 ? void 0 : _a[1];
                const end = (_b = getOrigRange(p.value)) === null || _b === void 0 ? void 0 : _b[0];
                if (start && end) {
...
function getOrigRange(node) {
    var _a;
    if ((_a = node === null || node === void 0 ? void 0 : node.cstNode) === null || _a === void 0 ? void 0 : _a.range) {
...
function parseAllDocuments(str, options) {
    const cst = (0, yaml_1.parseCST)(str);
    cst.setOrigRanges();
    const parsedDocuments = [];
    for (const cstDoc of cst) {
        const parsedDocument = new yaml_1.Document(Object.assign({ keepCstNodes: true }, options));
