        ...
        if (quick || !context) {
            ...
            if (!diagnosticsByFile || !lintAvailability || diagnosticsByFile === -1) {
                ...
                if (diagnosticsByFile === -1) {
                    console.debug("Ansible-lint command execution failed. Falling back to ansible syntax-check");
                    connection === null || connection === void 0 ? void 0 : connection.window.showInformationMessage("Falling back to ansible syntax-check.");
                }
